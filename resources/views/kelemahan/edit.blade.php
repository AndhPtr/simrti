        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Keterangan Keamanan Aset Organisasi</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('kelemahan.update', $kelemahan_aset->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="kategori_id" name="kategori_id" required>
                                ...
                                <option value="{{ $riskcategory->id }}" {{ old('risk_categories', $kelemahan_aset->asetKritis->kategori_id) == $riskcategory->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="aset_id" name="aset_id" required>
                                <option value="" disabled {{ old('aset_kritis', $kelemahan_aset->aset_id) == '' ? 'selected' : '' }}>Silahkan pilih risiko</option>
                                <option value="{{ $kelemahan_aset->aset_id }}" {{ old('aset_kritis', $kelemahan_aset->aset_id) == $kelemahan_aset->aset_id ? 'selected' : '' }}>
                                    {{ $kelemahan_aset->asetKritis->name }}
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="kelemahan" id="kelemahan" class="form-control" value="{{ old('kelemahan', $kelemahan_aset->kelemahan) }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="kebutuhan_keamanan" class="form-label">Kebutuhan Keamanan</label>
                            <input type="text" name="kebutuhan_keamanan" id="kebutuhan_keamanan" class="form-control" value="{{ old('kebutuhan_keamanan', $kelemahan_aset->kebutuhan_keamanan) }}" required>
                        </div>

                        <div class="mb-3">
                            <label for="praktik_keamanan" class="form-label">Praktik Keamanan</label>
                            <input type="text" name="praktik_keamanan" id="praktik_keamanan" class="form-control" value="{{ old('praktik_keamanan', $kelemahan_aset->praktik_keamanan) }}" required>
                        </div>
